...
--variant haplotypes/IFM_59355-1 \
--variant haplotypes/IFM_59355-2 \
--variant haplotypes/IFM_59356-1 \
--variant haplotypes/IFM_59356-2 \
--variant haplotypes/IFM_59356-3 \
--variant haplotypes/IFM_59361-1 \
--variant haplotypes/IFM_59361-2 \
--variant haplotypes/IFM_60237 \
--variant haplotypes/V130-15 \
--variant haplotypes/V130-14 \
--variant haplotypes/V130-18 \
--variant haplotypes/V130-54 \
--variant haplotypes/V157-39 \
--variant haplotypes/V157-40 \
--variant haplotypes/V157-47 \
--variant haplotypes/V157-48 \
--variant haplotypes/V157-62 \
--variant haplotypes/V157-59 \
--variant haplotypes/V157-60 \
--variant haplotypes/V157-61 \
--variant haplotypes/V157-80 \
